...
(******************************************************************************)
let appartient mot (Trie(a,d,r) )= appartient_arbre (d mot) a
...
(******************************************************************************)
let rec retrait mot (Trie(arbre, decompose, recompose)) = normalise (Trie(retrait_arbre (decompose mot) arbre,decompose,recompose))

let temp = retrait "bas" trie_sujet

let%test _ = appartient "bas" temp = false
let%test _ = appartient "ba" temp = false
let%test _ = appartient "ab" temp = false
let%test _ = appartient "lai" temp = true
let%test _ = appartient "bât" temp = true
...
(*   résultat   : aucun                                                       *)
(******************************************************************************)
let affiche p tri = let Trie(arbre, _, recomposition) = tri in List.iter p (List.map (fun e -> recomposition e ) (parcours arbre))
